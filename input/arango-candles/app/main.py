...
from app.telemetry import Telemetry, close_telemetry
...
async def handle_control_messages(telemetry: Telemetry):
...
async def main():
    ...
    await telemetry.send(status="started", message="Arango-candles consumer started")
