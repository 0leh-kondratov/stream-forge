...
KAFKA_TOPIC: str = os.getenv("KAFKA_TOPIC") # Input Kafka topic for prepared data
GRAPH_COLLECTION_NAME: str = os.getenv("GRAPH_COLLECTION_NAME") # ArangoDB collection for graph data
