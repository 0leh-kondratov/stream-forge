...
class TelemetryProducer:
    ...
    async def send_status_update(self, status: str, message: str = None,
        ...
        payload = {
            ...
            "arango_url": config.ARANGO_URL, # This might not be relevant for loader-producer
            "arango_db": config.ARANGO_DB, # This might not be relevant for loader-producer
            "collection_name": config.COLLECTION_NAME, # This might not be relevant for loader-producer
        }
        if error_message:
