...
KAFKA_TOPIC: str = os.getenv("KAFKA_TOPIC") # Input Kafka topic for orderbook data
COLLECTION_NAME: str = os.getenv("COLLECTION_NAME") # ArangoDB collection for orderbook data
